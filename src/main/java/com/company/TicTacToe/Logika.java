...
public class Logika {
    ...
    public static void ilePolObok_SI() {
        /*  Na czym opierać ma się sztuczna inteligencja w grze kółko i krzyżyk.
            ...
            - zmniejszenie ułożeń przecinikia (im mniej tym lepiej)  ! TUtaj bardzo ważne! Przy dwu ruchach
        */
        ...
        wypiszOcenyNadanePrzezSI();

    }

    public static void wypiszOcenyNadanePrzezSI() {
        System.out.println("-------Ocena wartości pól dla SI-------");
    ...
    public void ileMaPrzeciwnikDoKonca(){
